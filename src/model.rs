...
pub static DISPLAY_VALUES: phf::Map<&'static str, &'static [&'static str]> = phf_map! {
    ...
    "LoopSync" => &["Off", "On"],
    "TempoSync" => &["Off", "On"],
    "Input" => &["All", "MIC IN", "INST IN A", "INST IN B", "MIC/INST"],
    ...
    "Exp" => &[ "T1 LEVEL1", "T1 LEVEL2", "T2 LEVEL1", "T2 LEVEL2", "CUR LEVEL1", "CUR LEVEL2",
    "TEMPO UP", "TEMPO DOWN", "FX CONTROL", "RHYTHM LEV1", "RHYTHM LEV2", "MEMORY LEV1", "MEMORY LEV2",
],
    ...
    "TR1 PLY/STOP", "TR2 PLY/STOP", "CUR TR CHG", "SYNC START",
